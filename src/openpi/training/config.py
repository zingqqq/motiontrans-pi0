...
import openpi.policies.policy_motiontrans as motiontrans_policy
from openpi.policies.dataset_motiontrans import MotionTransDataset
    ...
    def __post_init__(self):
        ...
        object.__setattr__(self, 'data', LeRobotMotionTransDataConfig(
            ...
            base_config=MotionTransADataConfig(
                ...
                seed=self.seed,
                compute_norm_stats=self.compute_norm_stats,
                proprioception_rep=self.proprioception_rep,
...
_CONFIGS = [
    MotionTransTrainConfig(
        name="pi0_motiontrans",
        model=pi0.Pi0Config(action_horizon=16, max_token_len=75),
        weight_loader=weight_loaders.CheckpointWeightLoader("s3://openpi-assets/checkpoints/pi0_base/params"),
        num_train_steps=30_000,
    ),
    MotionTransTrainConfig(
        name="pi0_droid_motiontrans",
        model=pi0.Pi0Config(action_horizon=16, max_token_len=75),
